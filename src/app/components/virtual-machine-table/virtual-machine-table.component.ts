...
@Component({
  selector: 'app-virtual-machine-table',
  templateUrl: './virtual-machine-table.component.html',
  styleUrls: ['./virtual-machine-table.component.scss']
})
export class VirtualMachineTableComponent implements OnInit {
  constructor(public dialog: MatDialog) {
    console.log(this.categories[0].services[0].displayedCol);
  }
  categories: any = [
    {
      id: 0,
